...
public class CorrectChange_Loop {
  ...
  public static int makeChangeWithOneDenomination(int total,String denominationName,int denomination) {
    int value =0;
    for (int i =0; ((denomination*i) <= total); i++){ //loop through multiples of denomination until reaching largest integer less than or equal to total
      value =i;
    }
